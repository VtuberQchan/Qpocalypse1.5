...
function HApplyBurnTreatment:new(panel, bodyPart)
    return HApplyPoultice.new(self, panel, bodyPart, "BurnTreatment", "ContextMenu_BurnTreatment", ISQPBurnTreatment)
end
...
function HApplyPowderPackHemostatic:new(panel, bodyPart)
    return HApplyPoultice.new(self, panel, bodyPart, "PowderPackHemostatic", "ContextMenu_PackHemostatic", ISQPPowderPackHemostatic)
end

local HApplyTourniquet = HApplyPoultice:derive("HApplyTourniquet")
function HApplyTourniquet:new(panel, bodyPart)
    return HApplyPoultice.new(self, panel, bodyPart, "Tourniquet", "ContextMenu_Tourniquet", ISQPTourniquet)
end

local HApplyTourniquetNeck = HApplyPoultice:derive("HApplyTourniquetNeck")
function HApplyTourniquetNeck:new(panel, bodyPart)
    return HApplyPoultice.new(self, panel, bodyPart, "Tourniquet", "ContextMenu_Tourniquet", ISQPTourniquetOnNeck)
end
